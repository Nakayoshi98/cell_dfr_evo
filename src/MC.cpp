...
int main(int argc, const char **argv)
{
    ...
    string dir_name = "../data_random_noise" + str_delta + "/genes_" + to_string(genes) + "_MC_step/num_noise_type_" + to_string(num_noise_type) + "/max=" + to_string(max_fitness);
    ...
    while (true)
    {
        ...
        H[System_former.num_final_attractors] += 1;
        S[System_former.num_final_attractors] += f;
